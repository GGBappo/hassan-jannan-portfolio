window.PORTFOLIO_CONTENT = {
  ...
  sectionHeaders: {
    ...
    expertise: {
      kicker: "Strengths",
      title: "What I bring to a game team."
    },
    experience: {
      kicker: "Experience",
      title: "Leadership, development, and practical work."
    },
    education: {
      kicker: "Education",
  ...
  profile: {
    ...
    accentLine: 1,
    summary: "I am a junior at the University of New Haven studying Computer Science with a concentration in Game Design and Development. As President of the Game Development and Design Club, I help lead a collaborative student community while continuing to grow my hands-on experience in Unity. Over the past year and a half, I have led three game projects with a focus on gameplay systems, team coordination, and player-centered design.",
  ...
  highlights: [
    { label: "School", value: "University of New Haven" },
    { label: "Year", value: "Junior" },
    { label: "Experience", value: "1.5 years in game development" },
    { label: "Led Projects", value: "Gnome & Golem, CEPHEUS, and an educational cybersecurity game" }
  ],
  expertise: [
    {
      icon: "code",
    ...
    },
    {
      ...
      description: "Through class, club, and internship work, I have led projects, coordinated teammates, and helped keep development moving with clear direction.",
  ...
  experience: [
    {
      ...
      bullets: [
        ...
        "Encourage collaboration among students with different creative and technical strengths.",
        "Represent student leadership within the university's game development community.",
        "Help create a friendly environment focused on learning, teamwork, and growth."
      ]
    },
    {
      ...
      bullets: [
        "Coordinated teammates and kept the project moving from idea to playable build.",
        "Contributed gameplay implementation and Unity-based development work.",
        "Balanced technical execution with communication and leadership responsibilities.",
        "Developed and debugged core gameplay systems and interactive features using C++ and C#.",
        "Designed, tested, and iterated on gameplay mechanics to keep the experience intuitive and engaging.",
        "Documented design decisions and collaborated with teammates to align development with project goals.",
        "Used prototyping, feature iteration, and feedback review to improve usability and accessibility.",
        "Explored creative solutions for simulation-style challenges and youth-focused gameplay features."
      ]
    },
    {
    ...
    {
      role: "Important Classes",
      company: "University of New Haven",
      date: "Current",
      summary: "Coursework that has supported my growth in software development, systems thinking, and game development.",
      bullets: [
        "Intermediate C++/C",
        "Operating Systems",
        "Databases and SQL",
  ...
  projects: [
    ...
    },
    {
      ...
      detailsHeading: "What I worked on",
      details: [
          "Worked on main gameplay systems and level design.",
          "Did all the core game mechanics of the gnome and golem.",
  ...
  contact: {
    ...
    socials: [
      ...
      { label: "CEPHEUS", href: "https://itsupiki-okami.itch.io/cepheus", icon: "globe" },
      { label: "Gnome & Golem", href: "https://marvinooo.itch.io/gnomegolem", icon: "globe" }
    ]
  },
  footerNote: ""
};
